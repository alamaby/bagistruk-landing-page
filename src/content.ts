  ...
  en: {
    ...
    features: {
      ...
      items: [
        ...
        { title: "Manual bills", desc: "No receipt? Create a bill by hand with 0 scan credits." },
        { title: "Shareable bill links", desc: "Send a read-only link with expiry; viewers need no account." },
        { title: "Export PDF, CSV, XLSX", desc: "Export any bill on-device; XLSX sheets are Plus." },
        { title: "Monthly insights", desc: "Plus users see totals, trends, and top merchants." },
        { title: "Templates & duplicate", desc: "One-tap duplicate for recurring bills; save reusable templates." },
      ],
    },
    guide: {
      heading: "User guide",
      ...
      secondary: [
        "History shows saved bills, outstanding totals, and settlement status. Free accounts can view the last 30 days; Plus can view the last 365 days.",
    ...
    screenshots: {
      ...
      items: [
        { src: "/screenshots/scan-receipt.svg", caption: "Scan receipt" },
        { src: "/screenshots/review-bill.svg", caption: "Review extracted bill" },
        { src: "/screenshots/split-bill.svg", caption: "Assign items to participants" },
        { src: "/screenshots/settlement.svg", caption: "Track settlement" },
        { src: "/screenshots/history.svg", caption: "Search and organize history" },
        { src: "/screenshots/insight.svg", caption: "Monthly insight (Plus)" },
        { src: "/screenshots/share-link.svg", caption: "Share read-only link" },
        { src: "/screenshots/settings.svg", caption: "Credits, Plus & settings" },
      ],
    },
    trust: {
      ...
      points: [
        ...
        "Banner ads (AdMob) are feature-flagged and consent-gated via Google UMP where required.",
        "Plus subscriptions and credit packs use Google Play Billing with server-side verification.",
      ],
    },
    faq: {
  ...
  id: {
    ...
    features: {
      ...
      items: [
        ...
        { title: "Bill manual", desc: "Tanpa struk? Buat bill manual dengan 0 credit scan." },
        { title: "Link bill berbagi", desc: "Kirim link read-only berkedaluwarsa; penerima tanpa akun bisa melihat." },
        { title: "Export PDF, CSV, XLSX", desc: "Export bill di perangkat; sheet XLSX khusus Plus." },
        { title: "Insight bulanan", desc: "Pengguna Plus melihat total, tren, dan merchant teratas." },
        { title: "Template & duplikat", desc: "Duplikat satu tap untuk bill rutin; simpan template reusable." },
      ],
    },
    guide: {
      ...
      secondary: [
        "History menampilkan bill tersimpan, total outstanding, dan status lunas. Akun Free melihat 30 hari terakhir; Plus melihat 365 hari terakhir.",
    ...
    screenshots: {
      ...
      items: [
        { src: "/screenshots/scan-receipt.svg", caption: "Scan struk" },
        { src: "/screenshots/review-bill.svg", caption: "Review tagihan" },
        { src: "/screenshots/split-bill.svg", caption: "Bagi item ke peserta" },
        { src: "/screenshots/settlement.svg", caption: "Pantau pelunasan" },
        { src: "/screenshots/history.svg", caption: "Cari dan atur history" },
        { src: "/screenshots/insight.svg", caption: "Insight bulanan (Plus)" },
        { src: "/screenshots/share-link.svg", caption: "Bagikan link read-only" },
        { src: "/screenshots/settings.svg", caption: "Credit, Plus & pengaturan" },
      ],
    },
    trust: {
      ...
      points: [
        ...
        "Banner iklan (AdMob) ber-flag dan memakai consent Google UMP bila diwajibkan.",
        "Subscription Plus dan paket credit memakai Google Play Billing dengan verifikasi server-side.",
      ],
    },
    faq: {
